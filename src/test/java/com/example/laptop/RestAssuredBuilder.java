...
public class RestAssuredBuilder {
    ...
    private boolean logDetail = Boolean.parseBoolean(null);
    private ContentType contentType = ContentType.JSON; // Default
    ...
    public RestAssuredBuilder enableLogging(boolean logDetail) {
